...
var ZAxisContext = React25.createContext({
  zAxis: {},
  zAxisIds: []
});
if (true) {
...
function ZAxisContextProvider(props) {
  ...
  const zAxis = React25.useMemo(() => inZAxis == null ? void 0 : inZAxis.map((axisConfig) => {
...
var InteractionContext = React26.createContext({
  item: null,
  axis: {
    x: null,
    y: null
...
function InteractionProvider(props) {
  ...
  const [data, dispatch] = React26.useReducer(dataReducer, {
    item: null,
    axis: {
      x: null,
      y: null
  ...
  return (0, import_jsx_runtime7.jsx)(InteractionContext.Provider, {
    value,
    children
  });
}
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime10.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      return (0, import_jsx_runtime10.jsxs)(React36.Fragment, {
...
//# sourceMappingURL=chunk-LEEITTU6.js.map
