...
class Seng491DB(DeclarativeBase):  # Doğru miras alındı
    __tablename__ = 'Information_2019'  # __tablename__ özelliği doğru tanımlandı

    # Kolonlar burada tanımlanır
