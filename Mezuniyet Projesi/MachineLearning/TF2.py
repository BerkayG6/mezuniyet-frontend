...
model.fit(x=X_train, y=y_train, validation_data=(X_test,y_test),epochs=200,batch_size=500)
...
mean_absolute_error(y_test, predict) #0.18 error 
...
#tahmin etme 
veri=data.iloc[3250]
example=data.drop("ENROLLMENT_CHANGE_RATE",axis=1).iloc[3250]
print(example)
