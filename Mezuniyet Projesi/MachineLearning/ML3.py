...
latest_data = data[data['YEAR_ID'] == 24].copy()  # 2024 verisini al

latest_data['YEAR_ID'] = 25  # 2025 yılı
...
print(latest_data[['YEAR_ID', 'SUM_ENROLLMENT', 'FIELD_RATE', 'CAPACITY_CHANGE_RATE_PRED', 'CAPACITY_CHANGE_STATUS']])
