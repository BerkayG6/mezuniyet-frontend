...
data24_rate=data24["ENROLLMENT_CHANGE_RATE"]
data24=data24.drop(columns=["ENROLLMENT_CHANGE_RATE"])

data24_predict=best_xgb.predict(data24)

r3=r2_score(data24_rate,data24_predict)
print(r3)
