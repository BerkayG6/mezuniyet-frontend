...
data['UNIVERSITY_POPULARITY'] = data.groupby(['UNIVERSITY_ID', 'YEAR_ID'])['ENROLLMENT_CHANGE_RATE'].transform('mean')
...
X = data.drop(columns=['SUM_ENROLLMENT'])  # Bağımsız değişkenler
y = data['SUM_ENROLLMENT']  # Hedef değişken
...
print("MAE:", mae)
print("R2 Score:", r2)
#MAE: 0.2286357248442795 R2 Score: 0.9968919484581371
